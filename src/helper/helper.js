...
const sumProducts = (products) => {
    ...
    const totalPrice = products.reduce((totalPrice, product) => totalPrice + product.price * product.quantity, 0).toFixed(2)
...
export {shortenText, searchProducts, filteredProducts, createQueryObject, getInitialQuery, sumProducts, productQuantity}